...
const Quiz = () => {
  ...
  const { id: quizId } = useParams(); // taking param id from url bar and assigning it new name i.e., quizId
  ...
  const handleOptionClick = (optionId) => {
    ...
    questionResponse.qId = questionData.qId;
...
{
  /*      <div className={styles["options-container"]}>
            <button className={`${styles["option"]} ${styles["option1"]}`}>
              {questionData?.options?.[0].optionTitle}
            </button>
            <button className={`${styles["option"]} ${styles["option2"]}`}>
              Option 1
            </button>
            <button className={`${styles["option"]} ${styles["option3"]}`}>
              Option 1
            </button>
            <button className={`${styles["option"]} ${styles["option4"]}`}>
              Option 1
            </button>
          </div> */
}
